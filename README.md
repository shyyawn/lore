...
| [customize-cv](skills/customize-cv) | Career source `SOURCE.md` → IC or Manager job CV, freelance profile, or job LinkedIn; short cover letter when asked; tailor when a JD exists, else a base |
