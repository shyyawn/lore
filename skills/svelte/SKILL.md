...
| The next Kit major is **Not yet** | TypeScript language (`typescript-idioms`) |
...
| `@sveltejs/kit` 2.x | `$app/state` (2.12+), `load`, form actions | The next Kit major |
...
| API from a newer Kit major on a 2.x pin | **Not yet.** Stay on 2.x docs |
...
- APIs from a newer Kit major than the pin
